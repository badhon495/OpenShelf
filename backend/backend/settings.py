...
cloudinary.config(
    cloud_name=os.environ.get('CLOUDINARY_CLOUD_NAME', 'dzytspfsm'),
    api_key=os.environ.get('CLOUDINARY_API_KEY', '974184496451473'),
    api_secret=os.environ.get('CLOUDINARY_API_SECRET', 'dEHfbjaWaXXQJqXUIleHBUESTs0'),
    secure=True
)
